...
class DomainError(Exception):
    """ Любая ошибка доменного слоя, возникающая при нарушении бизнес-правила"""
...
class Book:
    ...
    MAX_DISCRIPTION_LEN: ClassVar[int] = 5000
    ...
    def __post_init__(self) -> None:
        ...
        self.description = self._norm_optional(self.description, "description", self.MAX_DISCRIPTION_LEN)
    ...
    def chenge_author(self, new_author:str) -> None:
    ...
    def change_description(self, new_description: str | None) -> None:
        self.description = self._norm_optional(new_description, "description", self.MAX_DISCRIPTION_LEN)
